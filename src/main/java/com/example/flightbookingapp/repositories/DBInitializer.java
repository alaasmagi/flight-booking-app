...
public class DBInitializer {
    ...
    public static void initializeDatabase() {
        ...
        try (Connection conn = DriverManager.getConnection(URL);
            ...
            String[][] flights = {
                    {"2025-04-01 12:30:00", "2025-04-01 10:00:00", "EGLL", "EETN", "299.99"},
                    {"2025-04-01 15:00:00", "2025-04-01 12:00:00", "ESSB", "EETN", "199.99"},
                    {"2025-04-01 18:45:00", "2025-04-01 16:30:00", "LETO", "EETN", "349.99"}
            };
            ...
            for (String[] flight : flights) {
                ...
                flightStmt.setDouble(5, Double.parseDouble(PRICE_FORMAT.format(Double.parseDouble(flight[4]))));
